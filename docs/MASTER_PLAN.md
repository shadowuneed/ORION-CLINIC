...
- [ ] Provider, specialty, service, schedule, and slot models.
- [ ] Read real availability through a versioned KMIS adapter.
- [ ] Capture patient date/time/provider preferences.
- [ ] Hold, confirm, cancel, reschedule, waitlist, and no-show flows.
- [ ] Idempotent booking and protection against concurrent double booking.
- [ ] Queue ticket, arrival, room, call, completion, and exception states.
- [ ] Patient and staff notifications.
- [ ] Manual fallback and reconciliation when KMIS is unavailable.

Gate: availability is never generated by AI; concurrent booking tests cannot
create two appointments in one slot.
...
- [ ] BMI, blood pressure, temperature, and other observation capture.
