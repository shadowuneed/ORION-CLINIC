...
Внутри дэшборда и очного приёма переходы сохраняют пациента, приём и выбранное
назначение. Это относится и к общей боковой панели. При недоступном назначении
