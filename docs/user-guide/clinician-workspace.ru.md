...
2. Левая навигация открывает только работающие разделы: рабочий день, реестр
   пациентов и очный приём. Направления, расписание/очередь и наблюдение не
   показываются как доступные функции, пока для них нет таблиц, API и проверенного
...
2. Зафиксируйте действующие решения для приёма, хранения расшифровки и локальной
   обработки аудио.
3. Нажмите **«Начать расшифровку»** и самостоятельно разрешите доступ к микрофону
   в браузере. ORION не выдаёт такое разрешение автоматически.
4. Говорите по очереди. Клиент калибрует уровень шума, держит короткий pre-roll,
...
5. Каждая финальная реплика получает видимую роль, язык и метку
   **«STT · требует проверки»**. Врач может исправить роль/язык/текст, после чего
   отображается **«Исправлено врачом · vN»**.
6. Нажмите **«Остановить расшифровку»** до смены пациента или перехода к проверке.
...
Врач открывает раздел, сверяет текст и основание, затем выбирает
...
## 11. Компактная навигация и мобильный режим
...
KMIS/ERDB/PUZ/ECG, production hosting, retention и disaster recovery.
